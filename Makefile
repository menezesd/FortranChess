...
# Source files
SRC = chess.f90 board_utils.f90 chess_types.f90 evaluation.f90 make_unmake.f90 move_generation.f90 search.f90 transposition_table.f90
OBJ = $(SRC:.f90=.o)
...
OBJS = chess_types.o transposition_table.o board_utils.o evaluation.o move_generation.o make_unmake.o search.o chess.o
...
chess.o: board_utils.o chess_types.o evaluation.o make_unmake.o move_generation.o search.o transposition_table.o
